...
void createMenu(gchar *menuName, gpointer vbox){
  GtkWidget *lbl, *btn;
  lbl = gtk_label_new(menuName);
...
int main (int argc, char *argv[])
{
  ...
  createMenu("แฟ้มข้อมูลหลัก", vbox);
  createMenu("ทำรายการ", vbox);
  createMenu("รายงาน", vbox);
  createMenu("จัดการระบบ", vbox);
  createMenu("ออกจากโปรแกรม", vbox);
